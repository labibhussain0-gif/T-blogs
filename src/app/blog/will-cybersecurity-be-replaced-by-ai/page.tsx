...
export default function CybersecurityReplaced() {
  ...
  const handleShare = useCallback((platform: 'twitter' | 'linkedin' | 'copy') => {
    const title = 'Will Cybersecurity Be Replaced by AI? The Honest Answer';
    const url = typeof window !== 'undefined' ? window.location.href : 'https://t-blogs.com/blog/will-cybersecurity-be-replaced-by-ai';
